...
import com.tang.community.service.ElasticsearchService;
...
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    static {
        try {
            epoch = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2004-10-10 00:00:00");
